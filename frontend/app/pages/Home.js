    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-500 to-purple-600 text-white">
      ...
      <section className="flex flex-col items-center justify-center py-16 px-4 text-center">
        ...
        <div>
          <a
            href="/signup"
            className="px-8 py-4 bg-yellow-400 text-black font-bold text-lg rounded-full shadow-lg hover:shadow-2xl hover:bg-yellow-500 transition-all duration-300"
          >
            Get Started
          </a>
        </div>
